...
(function(exports) {
    ...
    function createClass(name, superklass)
    {
        var protoklass = new Function();
        protoklass.prototype.func = new Function();
        protoklass.prototype.proto = protoklass.prototype;
        protoklass.prototype.name = name;
        
        if (superklass)
        {
            protoklass.prototype.__proto__ = superklass.proto;
            protoklass.prototype.func.prototype.__proto__ = superklass.proto.func.prototype;
        }
        else
        {
            ...
            protoklass.prototype.defineSubclass = function(name)
            {
                return createClass(name, this);
            }
            ...
            protoklass.prototype.func.prototype.sendMessage = function(selector, args)
            {
                return this[selector].apply(args);
            }
        }
        
        var klass = new protoklass;
        
        protoklass.prototype.func.prototype.klass = klass;
