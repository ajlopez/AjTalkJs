...
(function(exports, top) {
	...
	function Token(value, type)
	{
		...
		this.isBinaryOperator = function() { return (this.type == TokenType.Operator && this.value[0] != ':') || (this.type == TokenType.Separator && this.value==','); };
	}
	...
	Compiler.prototype.compileTerm = function(block, lexer)
	{
		...
		{
			block.compileByteCode(ByteCodes.NewList, 0);
			return;
		}
