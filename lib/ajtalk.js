...
(function(exports) {
    ...
    ProtoClass.prototype.defineMethod = function(name, method)
    {
		if (typeof method == "function")
			...
			this.func.prototype[name] = method.toFunction();
    };
    ...
    {
        var scls = new ProtoClass();
        scls.func.prototype.__proto__ = this.func.prototype;
        scls.instvarnames = instvarnames;
        scls.clsvarnames = clsvarnames;
        scls.name = name;
        Smalltalk[name] = scls;
        return scls;
    };
